...
//public class StompConfigSession extends AbstractSessionWebSocketMessageBrokerConfigurer<Session> {
//
//    @Override
//    protected void configureStompEndpoints(StompEndpointRegistry stompEndpointRegistry) {
//        stompEndpointRegistry.addEndpoint( "/server").setAllowedOrigins("*");
//    }
//
